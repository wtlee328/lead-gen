...
export const uiTexts: Record<LanguageCode, Translations> = {
    zh: {
        ...
        noSearchCriteria: "請在主要查詢欄位輸入搜尋條件，或填寫至少一個進階篩選條件。",
    ...
    en: {
        ...
        noSearchCriteria: "Please enter search criteria in the main query field or fill in at least one advanced filter.",
